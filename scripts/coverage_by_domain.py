...
DOMAINS = {
    ...
    "ACCT  account lifecycle": ["accounts/views.py", "accounts/models.py", "accounts/utils.py"],
    "VALID data validation": ["transactions/serializers.py", "transactions/paginations.py", "accounts/serializers.py"],
